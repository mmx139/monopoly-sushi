...
export const BOARD_TEMPLATES: Tile[] = [
  ...
  createPropertyTile(5, '纱縠行'),
  createPropertyTile(6, '来凤轩'),
  createTile(7, 'special', '丧母之痛', '1057年母亲病逝，守孝三年，原地停留3回合'),
  createPropertyTile(8, '嘉州驿馆'),
  createPropertyTile(9, '成都官驿'),
  createTile(10, 'random', '出川赴京'),
  createTile(11, 'reward', '出川赴京', '随机获得1张道具卡'),
  createPropertyTile(12, '茅厕'),
  createPropertyTile(13, '贡院'),
  createTile(14, 'poetry', '《南行集》', '抽诗词题卡'),
  createTile(15, 'quiz', '京城备考'),
  createTile(16, 'random', '随机事件'),
  createTile(17, 'special', '边角-汴京', '1061年科举考入第三等'),
  ...
  createTile(36, 'start', '湖州', '1079年乌台诗案，当前资产扣除到1000'),
